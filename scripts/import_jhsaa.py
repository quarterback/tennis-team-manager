...
RENAMES = {
    ...
    "Harrow School of Design and Engineering": "Harrow Works",
    ...
    "Canal View": "Canal Works",                               # 6A Orellana
    ...
    "Copper Lake East": "Copper Flat",                         # 6A Copper Lake
    ...
    "Loomis City North": "Loomis Junction",                    # 6A Loomis City
    ...
    "Telfair": "Telfair Central",                              # 4A Telfair
    "Timber Crest North": "Crestline",                         # 4A Fort Carden
    "Tindall Heights": "Tindall Bluff",                        # 5A Tindall
    ...
    "Leidesdorff Academy of Music and Media":           "Leidesdorff Works",
    ...
    "Jean Lindgren North":       "Valderra Wash",          # 4A Valderra
...
MASCOTS = {
    ...
    "Canal Works": "Headgates",                  # Orellana
