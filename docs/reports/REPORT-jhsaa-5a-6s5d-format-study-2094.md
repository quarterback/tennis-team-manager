...
courts, the most expansive card in the state — arguing it would make 5A the singles
class and get more players on court. The association's objection was roster capacity.
...
roster-floor decision, because sixteen on court against a floor of sixteen leaves a
...
152,522 varsity dual-sides, ~1.13m court results.

---

## 1. Capacity

Players on court is **S + 2D**. Verified rather than assumed: across all 152,522 varsity
dual-sides in the three exports, one player occupies exactly one court. No forfeits, no
double-booked lines anywhere in the archive.

5A, 445 program-seasons, against the old band (18, 20) and the old floor of 16:

| shape | courts | on court | min spare | median spare | % unable to field |
|---|---|---|---|---|---|
| 1S/4D *(the old card)* | 5 | 9 | 7 | 10 | 0.0% |
| 3S/4D | 7 | 11 | 5 | 8 | 0.0% |
| 4S/4D | 8 | 12 | 4 | 7 | 0.0% |
| 3S/5D | 8 | 13 | 3 | 6 | 0.0% |
| 4S/5D | 9 | 14 | 2 | 5 | 0.0% |
...
| shape | 5A dual-sides | failed to fill the card |
|---|---|---|
| 3S/4D | 9,071 | 0 |
| 1S/4D | 1,949 | 0 |
| 5S/2D | 1,012 | 0 |
...
Fifty-five distinct 5A programs have played 4S/5D — fourteen on court — in showcase pods
and tiered showcases, because under "the wider card wins" a 5A side drawn against a
wide-class host simply plays nine courts. Seventy-eight of those sides were played by
...
| shape | courts | singles share | who |
|---|---|---|---|
...
carries it through to what a court is worth, pricing S1 above D1 where every other table
ties them.

Eleven courts is odd, so a 6S/5D dual cannot tie. That is the reason to prefer it over
4S/4D and 3S/5D, the two other expansive shapes considered: both are eight courts, both
tie in 10.7–15.5% of duals (measured by re-scoring the 3,658 duals that actually
contested all nine courts), and adopting either would have meant adopting a tiebreak
...
**5A's card needs sixteen.** A floor-sized program would dress its whole roster with
...
old settings, every class in the association bottomed out at the same three-court JV
...
`lineup_need("regular")` — the **eleven-player league card**, hardcoded — not at the
postseason card. A road/State shape change therefore does not move the JV pool at all.

An earlier pass of this study assumed the cut followed the postseason card and reported
...
- **No 6S/5D dual had ever been played**, in any class, in any archived season when this
  was decided. Everything about the shape itself is arithmetic on roster sizes and court
...
- Only ten of the 231 5A dual-sides at 4S/5D were 5A-versus-5A; the rest were against
  larger classes in showcases. For "can they fill the card" the opponent is irrelevant.
