...
GLYPHS = {
    ...
    # four-legged, long-tailed — the Cascades' salamanders and newts
    "newt": "M23 12c0 1-1 2-2 2h-1c-1 0-2 1-3 2l-1 3-2-1 1-3c-1-1-2-1-3-1s-2 0-3 1l1 3-2 1-1-3c-1-1-2-2-3-2H3v-2h1c1 0 2-1 3-2L6 7l2-1 1 3c1 1 2 1 3 1s2 0 3-1l-1-3 2-1 1 3c1 1 2 2 3 2h1c1 0 2 1 2 2z",
}
...
MASCOT_GLYPH = [
    (("osprey", "falcon", "kestrel", "thunderbird", "owl", "heron", "sagehen",
      "sandpiper", "firebird", "hawk", "raven", "eagle", "gull", "pelican",
      "cormorant", "kingfisher", "tern", "loon", "egret", "petrel", "albatross",
      "godwit", "sanderling", "meadowlark", "waxwing", "skylark", "grouse",
      "goose", "geese", "crane", "grebe", "roadrunner", "peregrine",
      "chorister"), "wing"),
    (("steelhead", "salmonback", "whaler", "mariner", "silverleg", "trout",
      "sturgeon", "chinook", "sockeye", "kokanee", "salmon", "cutthroat",
      "springer", "shark", "skipjack", "rapids", "sardine", "rockfish",
      "longliner", "trawler", "gillnetter", "fishmonger"), "fish"),
    (("logger", "lumberjack", "axemen", "timber", "chokerman", "chokermen",
      "whistlepunk", "highclimber", "shingle weaver", "woodchopper",
      "log driver", "sawyer"), "axe"),
    (("miner", "prospector", "gold digger", "assayer", "silver king",
      "highgrader", "panner", "sluicer", "stonecutter", "marble cutter",
      "quarrier"), "pick"),
    (("mustang", "wrangler", "stampede", "vaquero", "drayman", "draymen",
      "hay baler", "haymaker"), "horseshoe"),
    (("cougar", "grizzlie", "grizzly", "badger", "wolf", "coyote", "marmot",
      "wolverine", "bobcat", "bear", "sable", "sea otter", "river otter"), "paw"),
    (("bighorn", "elk", "stag", "antler", "bull", "ram", "pronghorn", "lamb",
      "shearer", "shepherd", "woolgrower"), "horns"),
    (("pioneer", "drifter", "renegade", "ridgerunner", "stargazer", "cosmonaut",
      "orbiter", "meteor", "northern light"), "star"),
    (("storm", "lightning", "charge", "bolt", "thunderhead"), "bolt"),
    (("summit", "peak", "mountaineer", "caldera", "cinder cone", "snowcap",
      "avalanche", "lava bear", "obsidian"), "peak"),
    (("pine", "cedar", "evergreen", "huckleberr", "hawthorn", "live oak",
      "oaks", "bramble", "blossom", "sunflower", "sugar beet", "cherry picker",
      "orchardist", "applejack", "hop picker", "grape picker", "vintner"), "tree"),
    (("rattler", "anchor", "navigator", "sailor", "commodore", "skipper",
      "harbor seal", "sea lion", "otter", "muskrat", "crab", "harpoon",
      "deckhand", "seal", "riptide", "undertow", "longship", "riverboat",
      "lightkeeper", "riverman", "rivermen", "canalman", "canalmen",
      "headgate", "waterwheel", "ditchrider", "ditchwalker"), "anchor"),
    (("salamander", "newt", "ensatina", "rough skin", "tuatara"), "newt"),
]
